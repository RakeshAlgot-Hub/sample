...
import { Building, Home, ChevronDown, Plus } from 'lucide-react-native';
import { Header } from '@/components/Header';
import { useTheme } from '@/contexts/ThemeContext';

export default function PropertiesScreen() {
  const router = useRouter();
  const { properties, selectedPropertyId, isInitialized, initialize, selectProperty } = usePropertyStore();
